...
bitcore-message-zeroclassic adds support for verifying and signing zeroclassic messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-zeroclassic
```

```sh
bower install bitcore-message-zeroclassic
```
